...
const en: RegistrationCopy = {
  ...
  documentsRules: "PDF, JPEG, PNG or WebP · up to 10 MB per file",
  consent: {
...
const fr: RegistrationCopy = {
  ...
  documentsRules: "PDF, JPEG, PNG ou WebP · 10 Mo maximum par fichier",
  consent: {
  ...
  errors: {
    ...
    fileTooLarge: "Les fichiers doivent faire 10 Mo maximum.",
...
const ar: RegistrationCopy = {
  ...
  documentsRules: "PDF أو JPEG أو PNG أو WebP · بحد أقصى 10 ميغابايت للملف",
  consent: {
