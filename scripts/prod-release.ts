 ...
 * (audit refresh: production env secrets configured — read-only evidence pass; @next/env hoist fixed; pooler credentials refreshed — rerun audit; new password candidate; xget project confirmed — rerun audit)
 *
 * MODES
